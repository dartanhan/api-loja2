...
@section('content')
    ...
    <div class="form-row">
        <div class="col-md-12 mb-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item {{ Route::current()->getName() === 'admin.dashbord' ? 'active' : '' }}" aria-current="page"><h1 class="h4">Dashboard</h1></li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="container caja">
      <!--div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="col-md-12 mb-2">
            <div class="container">
                <form name="formFiltro" id="formFiltro" class="row" method="get" action="{{route('admin.dashbord')}}">
                    @csrf
                    <div class="col-sm-4 sm-4">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <h1 class="h5">Movimento Dia : Barão</h1>
                            </ol>
                        </nav>
                    </div>
