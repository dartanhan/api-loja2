...
@section('content')
        <div class="form-row">
            <div class="col-md-12 mb-2">
                ...
                <li class="breadcrumb-item {{ Route::current()->getName() === 'productBlock.index' ? 'active' : '' }}" aria-current="page">Produtos Bloqueados</li>
              </ol>
            </nav>
         </div>
    </div>
...
<script src="{{URL::asset('js/produto_block.js')}}"></script>
